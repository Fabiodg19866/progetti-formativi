// OGGETTI
let corso = {
  materia: ["javascript", "java", "php"],
  durata: 200,
  studenti: 16,
  esito: "idoneo",
  occupazione: "tirocinio",
};
corso.sviluppo = "web";
...
let classe = {
  numeroStudenti: 10,
  cittaStudenti: ["roma,milano", "torino"],
  nomiStudenti: ["luca", "paolo", "marco"],
  etaStudenti: [22, 23, 24, 25, 26],
  istituto: function () {
    return (
      this.nomiStudenti + "," + this.newstudents + " " + this.otherstudents
    );
  },
};
